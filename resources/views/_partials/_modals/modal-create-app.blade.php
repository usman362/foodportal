          ...
          <div class="bs-stepper-content p-1">
            <form onSubmit="return false">
              ...
              <div id="submit" class="content text-center pt-3 pt-lg-0">
                ...
                <!-- image -->
                <img src="{{asset('assets/img/illustrations/man-with-laptop-'.$configData['style'].'.png')}}" alt="Create App img" width="200" class="img-fluid" data-app-light-img="illustrations/man-with-laptop-light.png" data-app-dark-img="illustrations/man-with-laptop-dark.png">
