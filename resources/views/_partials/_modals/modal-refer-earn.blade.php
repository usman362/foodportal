        ...
        <form class="row g-3" onsubmit="return false">
          ...
          <div class="col-lg-3 d-flex align-items-end">
            <div class="btn-social">
              <button type="button" class="btn btn-icon btn-facebook me-2"><i class="tf-icons bx bxl-facebook"></i></button>
              <button type="button" class="btn btn-icon btn-twitter me-2"><i class="tf-icons bx bxl-twitter"></i></button>
