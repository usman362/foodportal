...
<div class="navbar-nav-right d-flex align-items-center row" id="navbar-collapse">
    <div class="col-7 card px-3 search-wrap" style="height: 64px;
    ">
        @if (!isset($menuHorizontal))
            <!-- Search -->
            <div class="navbar-nav align-items-center my-auto">
    ...
    <div class="col-1"></div>
    <div class="col-4 card" style="height: 64px;
    ">
        <ul class="navbar-nav flex-row align-items-center my-auto justify-content-between mx-3">
            @if (isset($menuHorizontal))
                <!-- Search -->
