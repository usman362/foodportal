          ...
          <div class="card border-primary border shadow-none">
            <div class="card-body position-relative">
              ...
              <div class="text-center">
                <div class="d-flex justify-content-center">
                  <sup class="h6 pricing-currency mt-3 mb-0 me-1 text-primary">$</sup>
                  <h1 class="price-toggle price-yearly display-4 text-primary mb-0">42</h1>
                  <h1 class="price-toggle price-monthly display-4 text-primary mb-0 d-none">49</h1>
            ...
            <div class="card-body">
              ...
              <div class="text-center">
                <div class="d-flex justify-content-center">
                  ...
                  <h1 class="price-toggle price-yearly display-4 text-primary mb-0">84</h1>
                  <h1 class="price-toggle price-monthly display-4 text-primary mb-0 d-none">99</h1>
