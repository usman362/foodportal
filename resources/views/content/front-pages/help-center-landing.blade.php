        ...
        <div class="row">
            ...
            <div class="card">
              <div class="card-body">
                <div class="d-flex align-items-center mb-2">
                  <span class="badge bg-label-primary p-2 rounded me-2"><i class="bx bx-cart bx-sm"></i></span>
                ...
                <p class="mb-0 fw-medium mt-4">
                  <a href="{{url('front-pages/help-center-article')}}" class="d-flex align-items-center">
                    ...
                    <i class="bx bx-arrow-right scaleX-n1-rtl"></i>
                  </a>
                </p>
              </div>
            </div>
            ...
            <div class="card">
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <span class="badge bg-label-primary p-2 rounded me-2"><i class="bx bx-help-circle bx-sm"></i></span>
                ...
                <p class="mb-0 fw-medium mt-4">
                  <a href="{{url('front-pages/help-center-article')}}" class="d-flex align-items-center">
                    ...
                    <i class="bx bx-arrow-right scaleX-n1-rtl ms-2"></i>
                  </a>
                </p>
              </div>
            </div>
          ...
          <div class="col-md-4 col-sm-6 mb-4">
            <div class="card">
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <span class="badge bg-label-primary p-2 rounded me-2"><i class="bx bx-dollar bx-sm"></i></span>
          ...
          <div class="col-md-4 col-sm-6 mb-4">
            <div class="card">
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <span class="badge bg-label-primary p-2 rounded me-2"><i class="bx bx-brush bx-sm"></i></span>
          ...
          <div class="col-md-4 col-sm-6 mb-4">
            <div class="card">
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <span class="badge bg-label-primary p-2 rounded me-2"><i class="bx bx-lock-open bx-sm"></i></span>
